...
const styles = makeStyles({
  ...
  plane: {
    ...
    opacity: 0,
    animation:
      "$plane-start .8s .8s ease-out, $plane-loop 1.6s 1.6s linear infinite"
  }
});

// const stopColor1 = "#f254f7";
// const stopColor2 = "#F55555";

// const stopColor1 = "#9500ff";
// const stopColor2 = "#1d0254";

const stopColor1 = "#1d0254";
const stopColor2 = "#1d0254";

const EmailVerifySvg = () => {
    ...
    <>
      <div className={classes.root}>
        <div className={classes.svgWrapper}>
          <svg className={classes.clouds} viewBox="0 0 243 172">
            <defs>
              <linearGradient id="a" x1="0%" y1="21.631%" y2="78.369%">
                <stop offset="0%" stopColor={stopColor1}></stop>
                <stop offset="100%" stopColor={stopColor2}></stop>
              </linearGradient>
