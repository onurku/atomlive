...
const useStyles = makeStyles({
  ...
  starTop: {
    backgroundImage: "url('/static/new-home/star-top.png')",
    backgroundSize: "auto",
...
const JoinOurCommunity = () => {
  ...
  const content = [
    {
      title: "Bilingual Reading Time: The Elves and The Shoemaker",
      videoId: "Yy9ipWLTqLk"
    },
    {
      title: "Bilingual Reading Time: The Wonderful Travelers",
      videoId: "CraDRRqrr4w"
    }
  ];
        ...
        <div className={`${classes.containerSection} container-section`}>
          ...
          >
            {content.map((item, index) => (
              ...
              >
                <Youtube
                  poster={`https://atomproduction.s3.amazonaws.com/public/website/info/${item.videoId}.jpeg`}
                  height="100%"
