      ...
      <Grid container justifyContent="center">
        <Grid item xs={10} md={6} lg={4}>
          ...
          <Typography sx={{ textAlign: "center" }} variant="h6">
            Click on the link in your email to reset password. If you can’t find
            the email, please check the spam or promotional folders.
          </Typography>
          <Typography sx={{ textAlign: "center" }} variant="body2">
            If the email did not arrive, you did not register with this email
            address.
          </Typography>
          <EmailVerifySvg />
        </Grid>
